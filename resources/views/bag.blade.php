            ...
            <table class="table table-actor">
                ...
                <tbody class="table__tbody">
                    ...
                    <tr class="table__tr">
                        ...
                        <td class="table__td">
                            <select class="form__select" id="pizza__size_{{ $pizza->id }}" name="pizza__size"
                                title="Pizza Size">
                        ...
                        <td class="table__td">
                            <input class="form__input" name="number" title="Pizza quantity" type="number" min="1"
                                max="15">
                        </td>
                    ...
                    <dd class="form__dd">
                        <div class="flex-row">
                            <input class="form__input" id="delivery" name="pizza__delivery-method"
                                title="PizzaHub'll drive to you" type="radio" value="delivery"><label
                                class="form__label" for="delivery">I'd like it delivered.</label>
